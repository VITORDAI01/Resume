...
const internships = [
  ...
  },
  {
    ...
    actions: [
      ...
      ["产品优化协同", "提出跳转路径简化、P90 延迟评测和 Agent Store 概念：参考 Steam 式应用分发，让用户在平台内完成算力调用、Agent 选择和 AI 应用使用闭环。"],
      ["专业内容发布", "负责品牌相关公众号内容发布，撰写赤兔、八卦炉等技术成果文章，把模型能力、产品进展和使用教程转译成开发者能理解的专业内容。"],
