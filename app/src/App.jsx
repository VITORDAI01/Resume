...
const internships = [
  {
    ...
    intro: "在同花顺 B2C 平台运营中，我重点从 0 到 1 搭建达人运营中台，把达人 BD、账号分层、选题匹配、内容跟进、社群维护和合作复盘沉淀到可追踪的数据链路中。2026 年 H1，同花顺整体新增用户中 17% 来自社媒渠道；抖音作为主阵地，看后搜约 80% 来自达人内容。中台的价值在于让达人合作不只停留在发布和曝光，而是能持续回收作品数据、复盘内容表现，并服务用户从“看到内容”到“主动搜索 / 下载”的关键转化动作。",
    proofPoints: [
      ...
      <main>
        ...
        {item.growthFlow && (
          <section className="case-section growth-flow-section" id="growth-flow">
            <div className="case-content" data-reveal>
              <span className="eyebrow">Growth Loop</span><h2>{item.id === "ths" ? "达人增长链路" : "账号增长链路"}</h2>
