...
const internships = [
  {
    ...
    logo: "ths-logo.png",
    logoAlt: "同花顺标志",
    role: "产品运营实习生 · 达人运营中台方向",
    period: "2026.03 — 至今",
    summary: "围绕 B2C 内容增长业务搭建达人运营中台，用轻量工具串联数据采集、达人主档、合作归档和复盘流程。",
    descriptor: "把分散的达人运营流程沉淀成可追踪、可复用的业务中台",
    heroImage: "ths-social-growth-bg.png",
    intro: "在同花顺 B2C 平台运营中，我的主要任务是搭建贴合业务的达人运营中台，把达人 BD、账号分层、选题匹配、内容跟进、社群维护和合作复盘沉淀到可追踪的数据链路中。2026 年 H1，同花顺整体新增用户中 17% 来自社媒渠道；抖音作为主阵地，看后搜约 80% 来自达人内容。中台的价值在于让达人合作不只停留在发布和曝光，而是能持续回收作品数据、复盘内容表现，并服务用户从“看到内容”到“主动搜索 / 下载”的关键转化动作。",
    proofPoints: [
    ...
    actions: [
      ["中台产品搭建", "基于 Streamlit 和飞书多维表格搭建达人运营中台，把待采集作品链接转成可复盘、可投流、可归档的数据，支持合作日期重采集、周复盘和月复盘口径。"],
    ...
    evidence: [
      {
        ...
        alt: "达人运营中台主面板截图",
        copy: "达人运营中台是这段经历里最核心的沉淀。原本达人作品、合作日期、视频数据和复盘字段分散在飞书表格、作品链接和人工记录中；中台把采集、重采集、达人主档和周复盘串成一个入口，让合作证据可以持续回收和复用。",
        modules: [
      ...
      },
      {
        kind: "agent",
        eyebrow: "Agent Plan",
        title: "AI 运营中台 Agent 规划与搭建",
        copy: "在现有达人运营中台基础上，我规划并搭建“达人业务协同与执行层”：业务方提出需求后，由 Agent 先整理需求、匹配历史案例和达人画像，再经过人工审批分发到达人合作、自营内容或数据复盘流程。",
        ...
        modules: [
          ...
          ["自营内容 Agent", "承接自营内容需求，生成栏目选题、脚本初稿、标题方向和发布建议。", "选题池 / 脚本初稿 / 内容排期", "人工确认内容质量与节奏"],
