...
const projects = [
  {
    ...
    href: "#/tools/zhuoqian",
    downloadHref: "downloads/zhuoqian-v2.0.2-macOS.zip",
    downloadLabel: "直接下载 v2.0.2",
  },
  {
    id: "danmu-saver",
    title: "弹幕屏保",
      ...
      <main className="tool-minimal-main">
        ...
        <section className="tool-minimal-hero">
          ...
          <div className="tool-minimal-actions">
            <a href={`${base}downloads/zhuoqian-v2.0.2-macOS.zip`} download>下载 macOS 版</a>
        ...
        <figure className="tool-settings-shot">
          ...
          <figcaption>v2.0.2 调整中号组件的信息层级与安全边距，任务管理页保留逐条编辑和完成归档。</figcaption>
        </figure>
